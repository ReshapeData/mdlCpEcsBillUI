...
#'
#' @examples
#' purchaseOrderUI_left()
purchaseOrderUI_left <- function() {
  ...
  res <- tagList(
    ...
    shinyWidgets::actionBttn(inputId = 'btn_purchaseOrderSourceSync_query',label = '源单查询')
...
purchaseOrderUI_right <- function() {
  res <- tagList(
    ...
    hr(),
    tsui::mdl_dateRange(id = 'dr_purchaseOrderSourceSync',label = '请输入起止日期范围'),
    shinyWidgets::actionBttn(inputId = 'btn_purchaseOrderSourceSync_summary',label = '同步分析汇总表'),
    shinyWidgets::actionBttn(inputId = 'btn_purchaseOrderSourceSync_detail',label = '同步分析明细表'),
    shinyWidgets::actionBttn(inputId = 'btn_purchaseOrderSourceSync_detail',label = '同步分析差异表'),
    tsui::mdl_download_button(id = 'dl_purchaseOrderSourceSync',label = '引出为Excel'),
    hr()
...
#' @examples
#' purchaseOrderUI_bottom()
purchaseOrderUI_bottom <- function() {
  res <- tagList(

    tsui::uiScrollX(tsui::mdl_dataTable(id = 'dt_purchaseOrderSourceSync_dataView'))
  )
  return(res)
